...
employeeDict = {"LastName": "",
                ...
                "Fax": "",
                "Email": ""}
studentDict = {} #define the student dict here like the employee dict
cricketDict = {} #define the cricket dict here
employeeKey = "LastName"
studentKey = "" #enter the student table key here
cricketKey = "" #enter the cricket table key here

attributes = {'employees':employeeDict,'student':studentDict,'cricket':cricketDict}
...
def post(table,att):
    ...
    for i in att.keys():
        ...
        att[i] = input()
    response = a.put("/"+table,params=att)
    print(response.json())
    return
...
def delete(table,key):
    ...
    val = input()
    response = a.delete("/"+table,params=val)
    print(response)
    return
    

val = getInput('Enter:\n1. Perform Get Request\n2. Perform Post Request\n3. Perform Put Request\n4. Perform Delete Request\n5. Exit',[1,2,3,4,5],ex=True)
table = tables[getInput('Select The Table to perform the request on:\n1. Employee\n2. Student\n3. Cricket',[1,2,3])]
